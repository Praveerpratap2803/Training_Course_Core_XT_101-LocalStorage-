...
const a=content.filter(
    function(b){
        return b.category === 'frontend'
    }
)
console.log(a);
console.log('-----------Next---------')

const b=content.filter(
    function(value){
        return value.location.city === 'Banglore'
    }
)
console.log(b);
console.log('-----------Next---------')
const c=content.find(
    function(value){
        return value.modes.online === true
    }
)
console.log(c);
console.log('-----------Next---------')
...
const d=content.find(
    function(value){
        if(value.modes.online === true && value.modes.inPerson === true){
            return value
        }
    }
)
